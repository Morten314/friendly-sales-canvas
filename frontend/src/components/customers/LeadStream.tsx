...
const mockLeads: Lead[] = [
  // Leads matched to Current ICPs (ICP 1 / ICP 2)
  {
    id: "c1",
    name: "Tom Bradley",
    company: "Nextera Software",
    title: "CTO",
    matchedICP: "ICP 1",
    fitScore: 90,
    intentLevel: "High",
    reason: "Matches ICP 1 buyer role (CTO) + North America region. Evaluating new platforms.",
  },
  {
    id: "c2",
    name: "Jessica Wu",
    company: "CodeVault Inc",
    title: "VP Engineering",
    matchedICP: "ICP 1",
    fitScore: 87,
    intentLevel: "High",
    reason: "Software & Technology, 200 employees. Active RFP for engineering tools.",
  },
  {
    id: "c3",
    name: "Ryan Mitchell",
    ...
    fitScore: 79,
    intentLevel: "Medium",
    reason: "Tech company, 150 employees. Recently raised Series B, expanding platform.",
  },
  {
    id: "c4",
    name: "Dr. Karen Wells",
    ...
    fitScore: 93,
    intentLevel: "High",
    reason: "Healthcare, 400 employees. Digital transformation initiative launched Q1.",
  },
  {
    id: "c5",
    name: "Oliver Grant",
    ...
    fitScore: 84,
    intentLevel: "High",
    reason: "UK Healthcare, 350 employees. Modernizing patient management systems.",
  },
  {
    id: "c6",
    name: "Fiona Reeves",
    company: "CareLogic Systems",
    title: "CIO",
    matchedICP: "ICP 2",
    fitScore: 71,
    intentLevel: "Medium",
    reason: "Healthcare IT, 250 employees. Legacy system migration underway.",
  },
  // Leads matched to Suggested/Refined ICPs
  {
    ...
    matchedICP: "Mid-Market SaaS – RevOps Teams",
    fitScore: 94,
    intentLevel: "High",
  ...
  },
  {
    ...
    matchedICP: "Growth-Stage E-commerce Leaders",
    fitScore: 88,
    intentLevel: "High",
  ...
  },
  {
    ...
    title: "CRO",
    matchedICP: "Enterprise FinTech Decision Makers",
    fitScore: 72,
    intentLevel: "Medium",
  ...
  },
  {
    ...
    fitScore: 92,
    intentLevel: "High",
    reason: "Matches refined ICP targeting RevOps teams. High engagement with your content.",
  },
  {
    id: "8",
    name: "Tobias Müller",
    ...
    fitScore: 68,
    intentLevel: "Medium",
    reason: "Matches new FinTech ICP segment. Digital transformation initiative underway.",
  },
  {
    id: "9",
    name: "Lily Tran",
    ...
    fitScore: 85,
    intentLevel: "High",
    reason: "Growth-stage leader. Similar buying patterns to best customers.",
  },
  {
    id: "10",
    name: "Raj Patel",
    ...
    fitScore: 76,
    intentLevel: "Medium",
    reason: "RevOps focus + Series B funding. Tech stack consolidation signals.",
  },
  {
    id: "11",
    name: "Nina Kowalski",
    ...
    fitScore: 82,
    intentLevel: "High",
    reason: "Digital transformation lead. Evaluating API-first partnerships.",
  },
  {
    id: "12",
    name: "Chris Andersen",
    company: "BrandBurst D2C",
    title: "COO",
    matchedICP: "Growth-Stage E-commerce Leaders",
    fitScore: 64,
    intentLevel: "Medium",
    reason: "Scaling operations. Platform migration in progress.",
  },
];
              ...
              <TooltipProvider delayDuration={200}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      <Bookmark
                        className={`h-3.5 w-3.5 ${savedLeads.has(lead.id) ? "fill-primary" : ""}`}
                      />
                    </Button>
                  </TooltipTrigger>
