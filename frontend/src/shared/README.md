...
- **Cross-cutting client-state primitives** (`shared/auth/`) and **cross-cutting components** (`shared/components/`) follow the same "consumed app-wide infrastructure" logic. Their placement is recorded in `docs/adr/0002-cross-cutting-client-state-and-components-live-in-shared.md`.
