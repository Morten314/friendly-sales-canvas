...
_The cross-feature API, re-exported from `index.ts`. Other features import only these, only via `@/features/market-research`._
...
- May import from: `@/features/market-research/*` (self), `@/shared/*`, `@/components/ui/*`, npm packages.
