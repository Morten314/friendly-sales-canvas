      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Input id="agentName" value={formData.agentName} disabled className="bg-gray-100" />
          </div>
          ...
          <div className="space-y-2">
            <Label htmlFor="generalInstructions">
              ...
              <span className="text-sm text-gray-500">(Prioritize high-signal data sources)</span>
            </Label>
            <Input
