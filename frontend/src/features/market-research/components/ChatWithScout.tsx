  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: "assistant",
      content:
        "Hi there! I'm Scout, your market research assistant. How can I help you find the right markets or leads today?",
    ...
    try {
      ...
      if (error instanceof Error) {
        if (error.message.includes("405")) {
          errorContent =
            "The API endpoint doesn't accept POST requests. Please check if the endpoint expects a different HTTP method (GET, PUT, etc.).";
            ...
            >
              <div
                className={`max-w-[80%] rounded-lg p-3 ${
                  message.role === "user" ? "bg-blue-100 text-blue-900" : "bg-gray-100"
                }`}
              >
