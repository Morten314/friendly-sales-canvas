...
Each constant is a literal prompt body with a single ``{company_profile_json}``
placeholder. The orchestrator calls ``.format(company_profile_json=...)`` on
...
RESEARCH_MARKET_1_TEMPLATE = """Task: Research and compile an updated overview of market, including size, segment breakdown, growth projections, strategic recommendations, and market drivers.
...
RESEARCH_MARKET_2_TEMPLATE = """Task: Research and compile an updated overview of industry trends, including technology adoption, regulatory changes, regional hotspots, and strategic recommendations.
...
RESEARCH_MARKET_3_TEMPLATE = """Task: Research and compile a comprehensive competitive landscape analysis, including competitor identification, market share data, SWOT analysis, recent news, feature comparisons, and market trends.
...
RESEARCH_MARKET_4_TEMPLATE = """Task: Research and compile a comprehensive regulatory and compliance analysis, including key regulatory updates, compliance frameworks, regional requirements, and strategic recommendations.
...
RESEARCH_MARKET_5_TEMPLATE = """Task: Research and compile a comprehensive market entry and growth strategy analysis, including entry barriers, channel strategies, competitive differentiation, SWOT analysis, and strategic timeline.
