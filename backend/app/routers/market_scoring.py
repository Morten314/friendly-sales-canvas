...
async def get_lead_market_scores_status(
    ...
    mongo_client = None
    try:
        mongo_client, score_coll, run_coll = market_scoring_service._get_market_score_collections()
...
async def get_lead_market_score_descriptions(
    ...
    mongo_client = None
    try:
        mongo_client, score_coll, _ = market_scoring_service._get_market_score_collections()
