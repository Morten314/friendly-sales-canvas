                    ...
                    <Card className="border-2 border-dashed">
                      <CardContent className="p-6">
                        <div className="space-y-4">
                          ...
                          {/* Custom Resource tab - commented out */}
                          ...
                          {addResourceMode === 'file' && (
                            <div className="space-y-4 pt-2">
                              ...
                              <div className="space-y-2">
                                <Label htmlFor="custom-file-url">File URL (Optional)</Label>
                                <Input
                                  id="custom-file-url"
                                  type="url"
                                  placeholder="Enter URL of the file (e.g., https://example.com/file.pdf)"
                                  value={customFileUploadUrl}
                                  onChange={(e) => {
                                    setCustomFileUploadUrl(e.target.value);
                                ...
                                />
                                <p className="text-xs text-muted-foreground">Enter a file URL or upload a file directly. You can use either option.</p>
                              </div>
                              <div className="flex gap-2">
                          ...
                          {/* API Integration tab - commented out */}
                          {false && addResourceMode === 'api' && (
                            <div className="space-y-4 pt-2">
