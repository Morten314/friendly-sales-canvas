            ...
            <div className="space-y-4">
              ...
              <Carousel className="w-full">
                <CarouselContent className="-ml-2 md:-ml-4">
                  {recentICPs.map(icp => <CarouselItem key={icp.id} className="pl-2 md:pl-4 basis-full md:basis-1/2 lg:basis-1/3">
                        ...
                        <CardContent className="space-y-4">
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {icp.keyTraits.map((trait, index) => <Badge key={index} variant="secondary" className="text-xs">
                                  {trait}
                                </Badge>)}
                            </div>
                          </div>
