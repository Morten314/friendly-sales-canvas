    ...
    <Layout>
      <div className="animate-fade-in h-full w-full flex flex-col">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 min-h-0 flex flex-col">
            ...
            <TabsContent value="chat-profiler" className="h-full w-full m-0 min-h-0 flex-1 flex flex-col overflow-hidden data-[state=active]:flex data-[state=active]:flex-col">
