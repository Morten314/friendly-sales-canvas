...
const MarketIntelligenceTab: React.FC<MarketIntelligenceTabProps> = ({
  ...
  const handleScoutChatClose = () => {
    setShowScoutChat(false);
  };

  const handleRevert = (editId: string) => {
    console.log('Reverting to edit:', editId);
    // Implement revert logic
  };

  const handleViewDetails = (editId: string) => {
    console.log('Viewing details for edit:', editId);
  ...
  return (
    <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => {
                        ...
                        setLastEditedField('Executive Summary');
                      }}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            setLastEditedField('APAC Growth Rate');
                          }}
                          placeholder="e.g., 25%"
                        />
                      </div>
                    ...
                    {strategicRecommendations.map((rec, index) => (
                      <Textarea
                        ...
                        onChange={(e) => {
                          ...
                          setLastEditedField('Strategic Recommendations');
                        }}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => {
                        ...
                        setLastEditedField('Market Entry Strategy');
                      }}
                      className="w-full h-32 resize-none"
                    ...
                    {marketDrivers.map((driver, index) => (
                      <Textarea
                        ...
                        onChange={(e) => {
                          ...
                          setLastEditedField('Market Drivers');
                        }}
      ...
      {showScoutChat && (
        <ScoutChatPanel
          showScoutChat={showScoutChat}
          isSplitView={isSplitView}
          hasEdits={hasEdits}
          showEditHistory={showEditHistory}
          editHistory={editHistory}
          lastEditedField={lastEditedField}
          onClose={handleScoutChatClose}
        />
      )}
