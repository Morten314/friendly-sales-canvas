...
const mockLeads: MatchedLead[] = [
  ...
  { id: "31", name: "Patrick O'Brien", email: "p.obrien@saasbridge.ie", company: "SaaSBridge", jobTitle: "Chief Revenue Officer", tenure: "4 years", source: "HubSpot", matchedReports: ["competitor-landscape", "market-entry"], signals: ["Competitor displacement", "UK/Ireland expansion"] },
  { id: "32", name: "Mia Santos", email: "m.santos@cloudscale.br", company: "CloudScale Brasil", jobTitle: "Director of Sales", tenure: "1 year 3 months", source: "Prospect List", matchedReports: ["competitor-landscape", "market-entry"], signals: ["Brazil SaaS growth", "Evaluating US-based tools"] },
  ...
  { id: "39", name: "Grace Lee", email: "g.lee@marketpulse.sg", company: "MarketPulse SG", jobTitle: "VP Growth", tenure: "1 year 6 months", source: "HubSpot", matchedReports: ["competitor-landscape"], signals: ["SEA competitive landscape", "Active market analysis"] },
