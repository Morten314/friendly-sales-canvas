                    ...
                    {editingSection === "icp-summary" ? <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 p-2 border rounded">
                            ...
                            <input type="text" defaultValue="Targeting mid-sized B2B FinTech companies (200–500 employees)" className="flex-1 bg-transparent border-none outline-none" />
                            <Button variant="ghost" size="sm">❌</Button>
                          </div>
                          <div className="flex items-center gap-2 p-2 border rounded">
                            <Globe className="h-4 w-4 text-green-600" />
                            <input type="text" defaultValue="Primary region: North America" className="flex-1 bg-transparent border-none outline-none" />
                            <Button variant="ghost" size="sm">❌</Button>
                          </div>
                          <div className="flex items-center gap-2 p-2 border rounded">
                            <Settings className="h-4 w-4 text-purple-600" />
                            <input type="text" defaultValue="Top use cases: Compliance automation, Risk analytics" className="flex-1 bg-transparent border-none outline-none" />
                            <Button variant="ghost" size="sm">❌</Button>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 group">
                          ...
                          <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-opacity" onClick={() => handleCopyInsight("Targeting mid-sized B2B FinTech companies (200–500 employees)")}>
                        ...
                        <div className="flex items-center gap-3 group">
                          ...
                          <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-opacity" onClick={() => handleCopyInsight("Primary region: North America")}>
                            <Copy className="h-3 w-3" />
                          </Button>
                        </div>
                        <div className="flex items-center gap-3 group">
                          ...
                          <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-opacity" onClick={() => handleCopyInsight("Top use cases: Compliance automation, Risk analytics")}>
                            <Copy className="h-3 w-3" />
                          </Button>
                        </div>
                      </div>}
                  </div>
                  {editingSection !== "icp-summary" && <Button variant="ghost" size="sm" onClick={() => handleEdit("icp-summary")} className="text-gray-500 hover:text-blue-600">
              ...
              <div className="space-y-4">
                <div className="flex gap-6">
                  <div className="flex-1 space-y-3">
                    {editingSection === "size-opportunity" ? <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 p-2 border rounded">
                            <DollarSign className="h-4 w-4 text-green-600" />
                            <input type="text" defaultValue="TAM: $14.2B" className="flex-1 bg-transparent border-none outline-none" />
                          </div>
                          <div className="flex items-center gap-2 p-2 border rounded">
                            <TrendingUp className="h-4 w-4 text-blue-600" />
                            <input type="text" defaultValue="CAGR: 5.6%" className="flex-1 bg-transparent border-none outline-none" />
                          </div>
                          <div className="flex items-center gap-2 p-2 border rounded">
                            <MapPin className="h-4 w-4 text-red-600" />
                            <input type="text" defaultValue="Top region: North America" className="flex-1 bg-transparent border-none outline-none" />
                          </div>
                          <div className="flex items-center gap-2 p-2 border rounded">
                            <Lightbulb className="h-4 w-4 text-yellow-600" />
                            <input type="text" defaultValue="Emerging pockets: Cross-border payments, AI-driven onboarding" className="flex-1 bg-transparent border-none outline-none" />
                          </div>
                        </div>
                        <div className="flex gap-2">
                          <Button size="sm" onClick={() => handleSave("size-opportunity")} className="bg-green-600 hover:bg-green-700">
                            <Save className="h-3 w-3 mr-1" />
                            Save Changes
                          </Button>
                          <Button size="sm" variant="outline" onClick={() => setEditingSection(null)}>
                        ...
                        <div className="flex items-center gap-3 group">
                          ...
                          <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-opacity" onClick={() => handleCopyInsight("TAM: $14.2B")}>
                            <Copy className="h-3 w-3" />
                          </Button>
                        </div>
                        <div className="flex items-center gap-3 group">
                          ...
                          <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-opacity" onClick={() => handleCopyInsight("CAGR: 5.6%")}>
                            <Copy className="h-3 w-3" />
                          </Button>
                        </div>
                        <div className="flex items-center gap-3 group">
                          ...
                          <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-opacity" onClick={() => handleCopyInsight("Top region: North America")}>
                            <Copy className="h-3 w-3" />
                          </Button>
                        </div>
                        <div className="flex items-center gap-3 group">
                          ...
                          <Button variant="ghost" size="sm" className="opacity-0 group-hover:opacity-100 transition-opacity" onClick={() => handleCopyInsight("Emerging pockets: Cross-border payments, AI-driven onboarding")}>
                            <Copy className="h-3 w-3" />
                          </Button>
                        </div>
                      </>}
                  ...
                  <div className="w-80 space-y-4">
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <MiniPieChart data={marketSegmentationData} title="" />
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="text-sm font-medium text-gray-700 mb-3">TAM Growth Trend</h4>
                      <MiniLineChart data={tamGrowthData} title="" color="#0064FF" />
                    </div>
                  </div>
                </div>

                <div className="flex justify-between items-center">
                  {editingSection !== "size-opportunity" && <Button variant="ghost" size="sm" onClick={() => handleEdit("size-opportunity")} className="text-gray-500 hover:text-blue-600">
