      ...
      try {
        ...
        if (buyerMapResponse && typeof buyerMapResponse === 'object') {
          ...
          const transformedData = {
            ...
            corePersonas: buyerMapResponse.coreBuyerPersonas || 0,

            topPainPoint: buyerMapResponse.topPainPoint || 'N/A',

            buyingTriggers: buyerMapResponse.buyingTriggersIdentified || 0,
       ...
       try {
         ...
         if (competitiveOverlapData && typeof competitiveOverlapData === 'object') {
           ...
           const transformedData = {
             ...
             competitors: competitiveOverlapData.numberOfMainCompetitors || 0,

             winLossChange: competitiveOverlapData.recentWinLossChange || 'N/A',

             activeBuyingSignals: competitiveOverlapData.activeBuyingSignals || 0,
