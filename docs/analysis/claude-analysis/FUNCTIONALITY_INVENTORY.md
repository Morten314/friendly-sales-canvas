...
| Test coverage | High | 5% | Four `test_*.py` smoke scripts hit the **live production** Render URL with hardcoded `USER_ID`/`ORG_ID`. No pytest framework, no fixtures, no CI automation. |
