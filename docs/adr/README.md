...
| 0002 | Cross-cutting client state and components live in `src/shared/` | accepted |
| 0003 | Keep market-research zod contracts feature-local | accepted |
| 0004 | Market-research TanStack cache is memory-only | accepted |
