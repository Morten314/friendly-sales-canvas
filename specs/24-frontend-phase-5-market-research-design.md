...
**Status:** Design — round 5 (rounds 1–4 reviews `docs/reviews/24-frontend-phase-5-market-research-design-spec-review-{1,2,3,4}.md` synthesized at `…-spec-synthesis-{1,2,3,4}.md` — round 4 refined the round-3 reconciliation; round 5 reconciles §4/§5 with shipped 5b reality after the 5c R1 escape hatch ×2 — see §9 deltas 7–8 / `docs/reviews/24c-frontend-phase-5c-R1-escape-hatch-findings.md`)
